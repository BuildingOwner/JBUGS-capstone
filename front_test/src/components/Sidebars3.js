...
import styles from "./Sidebars3.module.css";

const Sidebars3 = memo(() => {
  return (
        ...
        <div className={styles.courseNav}>
          ...
          <div className={styles.navitemWrapper}>
            <div className={styles.navitem3}>
              <div className={styles.bitcoinIconshomeOutline}>
                <img className={styles.hOME} alt="" src="/vector-3.svg" />
              </div>
              <div className={styles.homeWrapper}>
